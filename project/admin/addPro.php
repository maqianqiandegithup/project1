...
<table width="70%"  border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
	...
	<tr>
		...
		<td><input type="text" name="inventory"  placeholder="请输入商品数量"/></td>
	</tr>
	<tr>
		<td align="right">商品成本价</td>
		<td><input type="text" name="cPrice"  placeholder="请输入商品成本价"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="text" name="dicprice"  placeholder="请输入商品折扣"/></td>
	</tr>
	<tr>
		<td align="right">商品颜色</td>
		<td><input type="text" name="color1"  placeholder="请输入商品颜色"/>
		    <input type="text" name="color2"  placeholder="请输入商品颜色"/>
		    <input type="text" name="color3"  placeholder="请输入商品颜色"/>
		     <input type="text" name="color4"  placeholder="请输入商品颜色"/>
		</td>
