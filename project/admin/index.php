...
<title>京东电子商务后台系统</title>
<link rel="stylesheet" href="styles/backstage.css">
</head>

<body>
    <div class="head">
            <h3 class="head_text fr">京东电子商务后台管理系统</h3>
    </div>
    <div class="operation_user clearfix">
       <!--   <div class="link fl"><a href="#">京东商城</a><span>&gt;&gt;</span><a href="#">商品管理</a><span>&gt;&gt;</span>商品修改</div>-->
        <div class="link fr">
            <b>欢迎您
               <?php 
        ...
        <div class="main">
            ...
            <div class="cont">
                <div class="title">后台管理</div>
      	 		<!-- 嵌套网页开始 -->         
                <iframe src="main.php"  frameborder="0" name="mainFrame" width="100%" height="700"></iframe>
                <!-- 嵌套网页结束 -->   
            </div>
        </div>
        <!--左侧列表-->
                ...
                <ul class="mList">
                    ...
                    <li>
                        ...
                        <dl id="menu3" style="display:none;">
                            <dd><a href="OrderList.php" target="mainFrame">全部订单</a></dd>
                            <dd><a href="OrderList.php?type=未付款" target="mainFrame">待付款订单</a></dd>
                            <dd><a href="OrderList.php?type=待发货" target="mainFrame">待发货订单</a></dd>
                            <dd><a href="OrderList.php?type=待收货" target="mainFrame">待收获订单</a></dd>
                            <dd><a href="OrderList.php?type=待评价" target="mainFrame">待评价订单</a></dd>
                             <dd><a href="OrderList.php?type=交易成功" target="mainFrame">交易成功订单</a></dd>
                        </dl>
                    </li>
                    <li>
                        <h3><span onclick="show('menu4','change4')" id="change4">+</span>用户管理</h3>
                        <dl id="menu4" style="display:none;">
                        	<dd><a href="addUser.php" target="mainFrame">用户</a></dd>
                            <dd><a href="listUser.php" target="mainFrame">用户列表</a></dd>
                        </dl>
                    </li>
                     <li>
                        <h3><span onclick="show('menu5','change5')" id="change5">+</span>物流管理</h3>
                        <dl id="menu5" style="display:none;">
                        	<dd><a href="updateLogist.php" target="mainFrame">物流更新</a></dd>
                            <dd><a href="listUser.php" target="mainFrame">物流查询</a></dd>
                        </dl>
                    </li>
                    <li>
